(function () {
  ...
  angular
    .module('mnAnalyticsNewService', [
      'mnServersService',
      'mnFilters'
    ])
    .factory('mnAnalyticsNewService', mnAnalyticsNewServiceFactory);

  function mnAnalyticsNewServiceFactory($http, $q, mnServersService, mnCloneOnlyDataFilter, mnFormatQuantityFilter, mnParseHttpDateFilter, timeUnitToSeconds) {
    ...
    function getStats(params) {
      ...
      return mnAnalyticsNewService.doGetStats(params).then(function (resp) {
        var queries = [
          $q.when(resp)
        ];
        console.log(resp)
